    ...
    <footer className="border-t border-white/5 bg-elevated">
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          ...
          {/* Nav links */}
          <div>
            <p className="mb-5 font-body text-xs font-semibold uppercase tracking-[0.15em] text-cyan">
              Navigation
            </p>
              ...
              {SOCIAL_LINKS.map((social) => (
                <li key={social.label}>
                  <a
                    ...
                    className="flex items-center gap-3 text-ink-muted transition-colors duration-200 hover:text-ink"
                  >
                    {social.icon}
